                        ...
                        <div class="col-md-6 border rounded">
                            <div class="card-body">
                                ...
                                <form class="row g-3"
                                    ...
                                    <div class="col-md-12">
                                        <label for="inputPermissionCode"
                                            class="form-label">{{ __('Permission code') }}</label>
                                        <input type="text" class="form-control bg-primary-subtle border-primary"
                                            id="inputPermissionCode" value="{{ $permission->permission_code ?? '' }}"
                                            disabled>
                                    </div>
                                    <div class="col-md-12">
                                        <label for="inputPermissionName"
                                            class="form-label">{{ __('Permission name') }}</label>
                                        <input type="text"
